def call() {
    try {
        sh '''
            ...
            echo $scriptPath
            cp -f liquibase.properties liquibase.properties
            zip -r ${WORKSPACE}/${artifact}-${BUILD_NUMBER}.zip ${changelog} liquibase.properties artifact.properties config/* $validationFile
        '''
    } catch (e) {
